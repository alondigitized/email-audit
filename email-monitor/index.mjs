...
function buildContentPrompt(msg, screenshotPath, persona = null) {
  ...
  const parts = [
    ...
    "   Apply the Open Likelihood rubric from above. Layout exactly:",
    '   - **Score:** `X/10`',
    '   - **Signals counted:** name each rubric criterion that was TRUE (e.g. "sender recognizable, subject concrete, preview complements, segmented to my category"). Score must equal 1 + the count.',
    '   - **Rationale:** <1-2 sentences calling out the strongest signals>',
    '10. Click-Through Likelihood (persona-grounded)',
    '    Apply the Click Likelihood rubric from above.',
    '    - **Score:** `X/10`',

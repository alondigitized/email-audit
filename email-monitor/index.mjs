...
function buildContentPrompt(msg, screenshotPath, persona = null) {
  ...
  const parts = [
    ...
    '   The preview text (preheader) is what inbox clients show next to the subject line. A thoughtful preheader lifts open rates; leaking "View this email in your browser…" hurts them. Use this exact layout:',
    ...
    '   - **Strengths:** one or two short bullets',
    '   - **Weaknesses:** one or two short bullets',
    '   - **Alt A:** `<rewritten preheader you\'d test>`',
    '   - **Alt B:** `<second alternative>`',
    ...
    "   Estimate how likely YOU (the persona) would be to open this email, based on the subject line, preview text, sender familiarity, and your prior experience with this brand. This is not a deliverability prediction — it's YOUR gut reaction. Use this layout exactly so it can be parsed:",
    '   - **Score:** `X/10`',
    '   - **Rationale:** <1-2 sentences grounded in specific elements — what made you curious, what made you hesitate, what the sender/subject combination tells you>',
    '   Anchor: most everyday promotional emails land 3-6/10. Reserve 8+ for subjects that feel genuinely relevant or surprising to your persona.',
    '10. Click-Through Likelihood (persona-grounded)',
    '    Assuming you opened it, estimate how likely YOU would be to click a link or CTA — grounded in the hero, the offer, CTA placement and copy, visual hierarchy, and whether the content feels targeted at you. Same layout:',
    '    - **Score:** `X/10`',
    '    - **Rationale:** <1-2 sentences — what pulled you toward the click or away from it>',
    '    Anchor: most promotional emails land 2-5/10 for click-through. Reserve 7+ for offers that feel genuinely aimed at your persona AND have a clear, obvious CTA.',
    '11. Evidence',

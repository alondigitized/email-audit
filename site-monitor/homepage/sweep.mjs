...
function buildPrompt(persona, brandHostname, screenshotPath) {
  ...
  return [
    ...
    "You're already on the homepage — how likely would YOU scroll past the first screen, tap a category, or otherwise interact with the page (vs. bouncing back to wherever you came from)?",
    '- **Score:** `X/10`',

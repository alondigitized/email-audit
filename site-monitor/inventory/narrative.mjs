...
function buildUserPrompt({ scope, totals, plps, sizeProfile }) {
  ...
  lines.push(
    ...
    'BRAND FACT: Skechers sandals come in WHOLE sizes only — a sandal run of',
    '5,6,7,8,9,10,11,12 is COMPLETE. Never call a whole-size sandal run thin,',
    'and never recommend stocking half sizes for sandals.',

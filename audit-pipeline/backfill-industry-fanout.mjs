...
function buildContentPrompt(msg, persona) {
  ...
  return [
    ...
    "   Write `**X/10**` and a sub-bullet listing the rubric criteria from the rubric below that were TRUE.",
    "3. What's Working",
    "4. What's Weak",
    '5. Cross-Brand Read',
    '   How does this brand compare to others in your category right now? Who would do this email better? Worse?',
    '6. Recommendations',
    '7. Bottom Line',
    '',
    '── SCORING RUBRIC ──',
    ...
    '',
    'Style: medium length, first-person, opinionated, comparison-aware. Recommendations over root-cause theory.',
  ]
    .filter(Boolean)
    .join('\n');
}

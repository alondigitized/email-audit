...
function buildContentPrompt(msg, persona, categoryContext = null) {
  ...
  return [
    ...
    '',
    'Use this exact review structure. Sections 1-4 are PROSE / bullets for a reader',
    'on their commute. Sections 5-9 are STRUCTURED DATA — be precise, no extra prose.',
    '',
    '## 1. Overview',
    ...
    '',
    '## 2. What worked',
    'Bulleted list, first person. 2-5 specific wins — hero copy, offer clarity, demographic match, trust cues. Each bullet a short sentence. Comparison is welcome (e.g., "tighter hierarchy than Crate does").',
    '',
    "## 3. What didn't",
    'Bulleted list, first person. 2-5 specific misses — friction, irrelevance, broken hierarchy, mismatched offer. Each bullet a short sentence. If genuinely nothing missed, one line saying so.',
    '',
    "## 4. What I'd change",

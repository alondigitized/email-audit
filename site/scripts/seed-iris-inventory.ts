...
async function main() {
  ...
  const profile = personaProfileSchema.parse({
    ...
    color: "#e11d48",
    notes:
      "Hired secret-shopper persona — bargain-hunter member of the Inventory family (Ivy/Ian/Ida/Ike/Iris). Runs scheduled inventory audits against the Skechers /sale/ rack, judging markdowns by whether they are actually still buyable.",
    status: "active",
  });

...
export function ReviewContent({ markdown }: { markdown: string }) {
  ...
  return (
    <div className="prose prose-sm max-w-none prose-headings:mt-5 prose-headings:mb-2 prose-h2:text-base prose-h3:text-sm prose-p:my-2 prose-li:my-1 prose-ul:my-2">
